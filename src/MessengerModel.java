...
public class MessengerModel {
    ...
    public void registerUser(String username, String password) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/zhangeldy/Documents/Архитектура ПО/SoftwareArchitecture11/src/Users.txt", true))) {
    ...
    public boolean checkCredentials(String username, String password) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/zhangeldy/Documents/Архитектура ПО/SoftwareArchitecture11/src/Users.txt"));
            String line;
